...
- ui must contain locale (BCP 47), all these localized strings: ${uiStringKeys.join(", ")}, and suggestions (3 to 5 natural local-language property prompts). Preserve {provider}, {source}, and {time} placeholders in template strings.
