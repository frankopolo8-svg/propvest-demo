...
function createConcepts(brief: DemoBrief, copy: UiCopy): DemoProperty[] {
  ...
  const concepts = [
    ["Best match", `${type} with a balanced layout`, 0.9, ["Main image", "Living room", "Terrace"]],
    ["Best value", `${type} with practical potential`, 0.72, ["Renovated kitchen", "Parking", "Local setting"]],
