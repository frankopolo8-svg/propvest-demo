...
export function ChatKitPage() {
  ...
  async function retry() { if (!loading && lastMessage) await submitMessage(lastMessage, messages.at(-1)?.role !== "user"); }
