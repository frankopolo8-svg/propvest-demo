export const uiStringKeys = [
  ...
  "rentPerMonth", "beds", "baths", "retrievedFrom", "verifyListing", "requestFailed", "startDictation", "stopDictation", "bestMatch", "bestValue", "lowerCostOption", "largerOption", "premiumOption", "alternativeStyle", "tryAgain",
] as const;
...
export const defaultUi: UiCopy = {
  ...
  startDictation: "Start dictation", stopDictation: "Stop dictation", bestMatch: "Best match", bestValue: "Best value", lowerCostOption: "Lower-cost option", largerOption: "Larger option", premiumOption: "Premium option", alternativeStyle: "Alternative style", tryAgain: "Try again",
